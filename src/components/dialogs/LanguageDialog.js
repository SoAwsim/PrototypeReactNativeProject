    ...
    return (
        ...
        >
            <Dialog visible={visible} onDismiss={hideDialog}>
                <Dialog.Title>
                    {i18n.t('settingsScreen.sectionApp.lang', { locale: langContext.displayLang })}
                </Dialog.Title>
                <Dialog.Content>
                    <ScrollView>
                        {showUseSystem ? (
                            <CustomRadioItem
                                ...
                                label={i18n.t('settingsScreen.langDialog.sysLang', { locale: langContext.displayLang })}
                            />
                        ) : (
                            <Text>
                                {i18n.t('settingsScreen.langDialog.langWarn', { locale: langContext.displayLang })}
                            </Text>
                        )}
                        <CustomRadioItem
                            onPress={() => selectLang('en')}
                            radioValue="en"
                            radioStatusCondition={langContext.appLang === 'en'|| (langContext.appLang === 'system' && !showUseSystem)}
                            label="English"
                        />
                        <CustomRadioItem
                ...
                <Dialog.Actions>
                    <Button onPress={hideDialog}>
                        {i18n.t('settingsScreen.cancel', { locale: langContext.displayLang })}
                    </Button>
                </Dialog.Actions>
            </Dialog>
        </Modal>
